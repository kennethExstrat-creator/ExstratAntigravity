...
function App() {
  ...
  return (
    <div className={`min-h-screen relative transition-colors duration-700 ${isDark ? 'dark' : ''}`}>
      ...
      <div
        className={`fixed inset-0 z-0 bg-slate-50 transition-opacity duration-1000 ease-in-out ${isDark ? 'opacity-0' : 'opacity-100'
          }`}
      >
      ...
      <div
        className={`fixed inset-0 z-0 bg-slate-950 transition-opacity duration-1000 ease-in-out ${isDark ? 'opacity-100' : 'opacity-0'
          }`}
      >
